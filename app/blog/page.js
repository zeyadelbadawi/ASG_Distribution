...
export default function Home() {
  ...
  const handleSearchChange = (e) => {
    ...
    if (value) {
      const filteredSuggestions = blogData.filter((post) => post.title.toLowerCase().includes(value.toLowerCase()))
                      ...
                      <li>
                        ...
                        <div className="sidebar__post-content">
                          <p className="sidebar__post-date">
                            <span className="icon-calender"></span>October 19, 2022
                          </p>
                          <h3 className="sidebar__post-title">
                            <Link href="blog-details">Your safety is our priority</Link>
                          </h3>
                        </div>
                      </li>
