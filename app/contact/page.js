...
export default function Home() {
    ...
    <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Contact">
                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-4">
                                <div className="contact-page__contact-info-single">
                                    <div className="contact-page__contact-info-icon">
                                        <span className="icon-call-3"></span>
                                    </div>
                                    <div className="contact-page__contact-info-content">
                                        <h5>Contacts</h5>
                                        <p><Link href="tel:010 50638800">010 50638800</Link></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4">
                                <div className="contact-page__contact-info-single">
                                    ...
                                    <div className="contact-page__contact-info-content">
                                        <h5>4 Dr Mohamed Awad Street</h5>
                                        <p> in Front of City Center</p>
                                    </div>
                                </div>
                            </div>
                            {/*Contact Page Contact Info Single End*/}
        ...
        <section className="contact-page-google-map">
            <div className="container">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4434.470934306312!2d31.34009727053525!3d30.069344079300453!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583f92ba92b499%3A0xe71112fc96b95222!2sASG%20Distribution!5e0!3m2!1sen!2seg!4v1727043503231!5m2!1sen!2seg"
                    className="google-map__two" ></iframe>
            </div>
        </section>
        {/*Google Map End*/}
