      ...
      <section className="feature-one">
        <div className="container">
          <div
            ...
            style={{ maxWidth: "70%", marginTop: "20px", position: "relative", zIndex: 1 }}
          >
            <span className="section-title__tagline" style={{ marginBottom: "20px" }}>
              features
            </span>
            <h2
              className="section-title__title"
              style={{ marginBottom: "30px", whiteSpace: "normal", wordWrap: "break-word" }}
            >
              {featuresData.title}
            </h2>
          </div>
              ...
              <div className="tabs-content">
                {featuresData.tabs.map((tab, index) => (
                  <div
                    key={index}
                    className={
                      activeIndex === index ? "tab fadeInUp animated show active-tab" : "tab fadeInUp animated"
                    }
                  >
                        ...
                        <li key={idx}>
                          <div
                            ...
                            style={{
                              ...
                              backgroundColor: "#fff",
                              boxShadow:
                                hoveredIndex === idx ? "0 10px 20px rgba(0,0,0,0.15)" : "0 5px 10px rgba(0,0,0,0.1)",
                              cursor: "pointer",
                              color: hoveredIndex === idx ? "#EB7230" : "#000",
                            }}
